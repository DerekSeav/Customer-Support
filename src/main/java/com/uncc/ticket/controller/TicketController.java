...
public class TicketController {
    ...
    public String editTicket(Model model,@PathVariable("id") Long id) {
        model.addAttribute("ticket", new TicketEntity(ticketService.findById(id).getTitle(), id, ticketService.findById(id).getUsers(), ticketService.findById(id).getMessage()));
        return "tickets/storeTicket";
    }
